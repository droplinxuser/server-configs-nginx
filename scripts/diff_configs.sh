...
declare -A config_files=(
    ...
    ["nginx_additional"]="https://raw.githubusercontent.com/droplinxuser/server-configs-nginx/main/http.d/ppa_eilander_conf /etc/angie/http.d/ppa_eilander.conf"
    ["brotli_conf"]="https://raw.githubusercontent.com/droplinxuser/server-configs-nginx/main/http.d/brotli_conf /etc/angie/http.d/brotli.conf"
    ["http_trim_filter_conf"]="https://raw.githubusercontent.com/droplinxuser/server-configs-nginx/main/http.d/http_trim_filter_conf /etc/angie/http.d/http_trim_filter.conf"
